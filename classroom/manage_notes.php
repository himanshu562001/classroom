    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <h1 class="mb-2 bread">Manage Notes</h1>
...
<section class="ftco-section contact-section">
    <div class="container">
        <div class="row d-flex contact-info">
            <div class="col-md-12">
                <a href="notes.php" class="btn btn-primary float-right">Add Notes</a>
            </div>
              ...
              ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_notes.php?id=<?php echo $data['id'];?>">
                                    <i class="fa fa-edit text-success fa-2x"></i>
                            </td>
                            <td>
                                <a href="delete_notes.php?id=<?php echo $data['id'];?>">
